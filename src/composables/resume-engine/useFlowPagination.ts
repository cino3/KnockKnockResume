...
const FIRST_PAGE_PADDING_BOTTOM = 16 // 第1页下边距
...
const FIRST_PAGE_STRETCH_BASE_PADDING = 22
...
export const applyFirstPageWhitespaceStretch = (
  ...
  // Keep whitespace stretch budget stable even if first-page bottom padding changes.
  // This decouples "page bottom padding" from "section gap distribution".
  const emptySpace = firstPageMargin - FIRST_PAGE_STRETCH_BASE_PADDING
